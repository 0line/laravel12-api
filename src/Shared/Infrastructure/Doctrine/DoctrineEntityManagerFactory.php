...
namespace Zeroline\Shared\Infrastructure\Doctrine;

use Zeroline\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegistrar;
...
final class DoctrineEntityManagerFactory
{
	private static array $sharedPrefixes = [
		__DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'Zeroline\Shared\Domain',
	];
