...
use Zeroline\Backoffice\Auth\Application\Authenticate\AuthenticateUserCommand;
use Zeroline\Backoffice\Auth\Domain\InvalidAuthCredentials;
use Zeroline\Backoffice\Auth\Domain\InvalidAuthUsername;
	...
	private function askForCredentials(RequestEvent $event): void
	{
		$event->setResponse(
			new Response('', Response::HTTP_UNAUTHORIZED, [
				'WWW-Authenticate' => 'Basic realm="Zeroline"',
			])
		);
	}
}
